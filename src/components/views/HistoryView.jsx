          ...
          {bills.length === 0 ? (
            ...
            <div key={b.id} onClick={() => fetchBillDetail(b.id)}
              ...
              <div className="flex justify-between font-semibold text-sm">
                <span>Bàn {b.table_num}</span><span className="text-green-400">{formatMoney(b.total)}</span>
              </div>
            ...
            <div className="flex flex-col gap-3 max-w-sm">
              ...
              <div className={`${bgCard} rounded-xl p-4`}>
                ...
                <div className="flex justify-between font-bold">
                  <span>THÀNH TIỀN</span><span className="text-green-400">{formatMoney(selectedBill.total)}</span>
                </div>
              </div>
            </div>
          ) : (
