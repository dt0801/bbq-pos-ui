...
function AppInner() {
  ...
  const staffHook    = useStaff(apiFetch);
  ...
  const { statsToday, statsMonthlyData, statsYearlyData, statsTab, setStatsTab, statsMonth, setStatsMonth, statsYear, setStatsYear, statsPickedDate, setStatsPickedDate, fetchStatsByDate, fetchStatsMonthly, fetchStatsDaily, fetchStatsYearly, fetchAllStats, staffStatsDay, staffStatsMonth, staffStatsYear } = statsHook;
